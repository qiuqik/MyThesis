...
\begin{figure}[ht]
    ...
    \bicaption{Ray Marching方法和SSR方法效果对比}{Comparison of Ray Marching Method and SSR Method}
    \label{fig:render1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=12cm]{image/compare2.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=12cm]{image/compare.png}
